<div class="row responsive-row">
    <div class="col-xxl-3 col-sm-6">
        <x-admin.ui.widget.four :url="route('admin.user.all')" variant="primary" title="Total Users" :value="$widget['all']"
    ...
    <div class="col-xxl-3 col-sm-6">
        <x-admin.ui.widget.four
            ...
            variant="success" title="Users Joined Last Week" :value="$widget['week']" icon="las la-calendar"
            :currency=false />
    </div>
    <div class="col-xxl-3 col-sm-6">
        <x-admin.ui.widget.four
