...
@section('panel')
    <div class="row gy-4">
                ...
                <x-admin.ui.card.body>
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap ps-0">
                            ...
                            <span class="fs-14">
                                <a
                                    href="{{ route('admin.collector.detail', $withdrawal->collector_id) }}"><span>@</span>{{ @$withdrawal->driver->username }}</a>
                            </span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap ps-0">
        ...
        <div class="col-lg-8 col-md-6">
            ...
            <x-admin.ui.card>
                <x-admin.ui.card.header>
                    <h4 class="card-title">@lang('Waste Collector Withdraw Information')</h4>
                </x-admin.ui.card.header>
                <x-admin.ui.card.body>
                    @if ($details != null)
