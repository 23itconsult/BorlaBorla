        ...
        <div class="dashboard-quick-link header-dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-end">
                <div class="quick-link-list">
                    ...
                    <a href="{{ route('admin.user.all') }}" class="quick-link-item">
                        <span class="quick-link-item__icon">
                            <i class="las la-users"></i>
                        </span>
                        <span class="quick-link-item__name">@lang('All Rider')</span>
                    </a>
                    <a href="{{ route('admin.user.active') }}" class="quick-link-item">
                        <span class="quick-link-item__icon">
                            <i class="las la-user-check"></i>
                        </span>
                        <span class="quick-link-item__name">@lang('Active Rider')</span>
                    </a>
                    <a href="{{ route('admin.user.banned') }}" class="quick-link-item">
                        <span class="quick-link-item__icon">
        ...
        <div class="dashboard-header-user">
            ...
            <div class="dropdown-menu dropdown-menu-end user__area">
                <div class="user__header">
                    <a href="{{ route('admin.adminprofile',0) }}" class="user__info">
                ...
                <div class="user__body">
                    <nav class="user__link">
                        <a href="{{ route('admin.adminprofile',0) }}" class="user__link-item">
