...
class ManageRiderController extends Controller
{
    public function allUsers()
    {
        ...
        return view('admin.user.list', compact('pageTitle', 'users', 'widget'));
    }
    ...
    public function detail($id)
    {
        ...
        $pageTitle = 'User/Household Detail - ' . $user->username;
        $loginLogs = UserLogin::where('user_id', $user->id)->take(6)->get();

        $paymentQuery = WastePickupPayment::where('user_id', $user->id);
        ...
        return view('admin.user.detail', compact('pageTitle', 'user', 'widget', 'countries', 'loginLogs'));
    }
