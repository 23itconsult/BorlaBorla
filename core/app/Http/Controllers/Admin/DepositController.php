...
class DepositController extends Controller
{
    public function pending()
    {
        ...
        $deposits    = $baseQuery->with(['collector', 'gateway'])->paginate(getPaginate());
    ...
    {
        $deposit   = Deposit::where('id', $id)->with(['collector', 'gateway'])->firstOrFail();
        $pageTitle = $deposit->collector->username . ' requested ' . showAmount($deposit->amount);
    ...
    public function reject(Request $request)
    {
        ...
        notify($deposit->collector, 'DEPOSIT_REJECT', [
    ...
    {
        $baseQuery = Deposit::$scope()->searchable(['trx', 'collector:username'])->filter(['collector_id'])->dateFilter();
        $request   = request();
