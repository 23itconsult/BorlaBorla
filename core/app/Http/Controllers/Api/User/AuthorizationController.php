...
{
    protected function checkCodeValidity($user, $addMin = 5)
    {
    ...
    public function sendVerifyCode($type)
    {
        ...
        if ($this->checkCodeValidity($user)) {
            $targetTime = $user->ver_code_send_at->addMinutes(1)->timestamp;
    ...
    public function emailVerification(Request $request)
    {
        ...
        $notify[] = 'Verification code '.$request->code. ' doesn\'t match';
